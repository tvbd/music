    ...
    results_objects[song_id] = {
      ...
      <div class="row" style="margin:auto;">
          ...
          <div class="col" style="border-style:none;padding:2px;">
              ...
              <button class="btn btn-primary song-btn" type="button" style="margin:0px 2px;color:#fff" onclick='AddDownload("${song_id}")'>DL</button>
              <p class="float-right fit-content" style="margin:0px;padding-right:10px;padding-top:15px;color:#red">${play_time}<br/></p>
          </div>
      </div>
  </div>
`
